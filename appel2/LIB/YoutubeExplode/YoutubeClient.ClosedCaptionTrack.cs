...
namespace YoutubeExplode
{
    ...
    {
        /// <inheritdoc />
        public ClosedCaptionTrack GetClosedCaptionTrackAsync(ClosedCaptionTrackInfo info)
        {
            info.GuardNotNull(nameof(info));

            // Get manifest
            var raw = _httpClient.GetStringAsync(info.Url).Result;//.ConfigureAwait(false);
